...
public class ProdutoService {
    ...
    public Page<ProdutoModel> getProdutoAtivoList(Pageable pageable) {
        ...
        try {
            ...
            Page<ProdutoModel> produtos = produtoRepository.findAllByOrderByProdutoIdDescAndImagemPadraoWhereAtivo(page);
